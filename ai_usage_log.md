...
## Team: Nerds - MoMo Project
## Week: 2

| Date       | Tool Used | Purpose                      | What We Changed |
|------------|-----------|------------------------------|-----------------|
| 2024-05-10 | Grammarly | Grammar checking in README   | Fixed grammar errors in database documentation|
| 2024-05-10 | Google    | Research on MySQL data types | Used VARCHAR vs TEXT decision for raw_body column          |
